...
export const TeamLayout = () => {
    ...
    const teamMembers: Record<string, { name: string; role: string; img: string }[]> = {
        ...
        mechanical: [
            ...
            { name: "Kyan Barnett",             role: "Mechanical Member",        img: "/team_page_media/mech_team/Kyan Barnett.JPG" },
            { name: "Alex Lee",                 role: "Mechanical Member",        img: "/revolt_logo_invert.png" },
            { name: "Kiril Varakin",            role: "Mechanical Member",        img: "/revolt_logo_invert.png" },
        ...
        electrical: [
            ...
            { name: "Tristan Luo",              role: "Electrical Member",        img: "/team_page_media/elec_team/Tristan Luo.JPG" },
            { name: "Andy Want",                role: "Electrical Member",        img: "/team_page_media/elec_team/Andy Want.JPG" },
        ],
        software: [
